...
def get_vminfo(vm):
    ...
    vminfo['vcenter_date'] = si.CurrentTime()
    vminfo['createdate'] = datetime.now()
    return vminfo
...
def get_host_info(host):
    ...
    if host_obj:
    	...
    	if hasattr(runtime.dasHostState,'state'):
            host_info['dasHostState'] = runtime.dasHostState.state
        else:
            host_info['dasHostState'] = ""
        ...
        host_info['vcenter_date'] = si.CurrentTime()
        host_info['createdate'] = datetime.now()
